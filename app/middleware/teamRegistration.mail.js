    ...
    <body>
        <div class="bg">
            ...
            <div class="text">
                ...
                <p>Dear {vEmail},
                    Your Team has been registerd successfully for {vTitle}
                    Your TeamId is: <b>{TeamId}</b>
...
`
module.exports = function sendEmail(vEmail, vTitle , TeamId ) {
    ...
    var mailOption = {
        ...
        html: template.replace('{vEmail}', vEmail).replace('{vTitle}', vTitle).replace('{TeamId}',TeamId)
    };
